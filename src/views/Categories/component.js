...
function Categories(props) {
  ...
  const [minimumQuantity, setMinimumQuantity] = useState(
    catelogData?._id ? catelogData?.minimumQuantity : ""
  );
  ...
  const getCategories = async () => {
    try {
      ...
      if (response.data?.success) {
        ...
        const groceryItem = response?.data?.data.find(item => item.title === "Grocery");
        if (groceryItem) {
          setsubCategoriesList(groceryItem.subCategories);
        }
  ...
  const addCatelog = async (status) => {
    ...
    try {
      ...
      //
        ...
        "sellerId": catelogData?.userId,
        "type": "updateItem",
        "itemId": catelogData && catelogData._id ? catelogData._id : "",
      }
      if (catelogData?.categoryId == "Food & Beverage") {
                      ...
                      <div className="col-md-6 mb-3  gap-2 ">
                        ...
                        >
                            check
                              ...
                              <div className="col-md-6 mb-6  gap-2">
                                <label className="mb-1">
                                  Available Quantity*
                                </label>
                                <input
                              ...
                              <div className="col-md-6 gap-2 mb-3">
                                <label className="mb-1">
                                  Maxiumum Items Per Order
                                </label>
                                <input
                                  type="number"
                                  placeholder="Maxiumum Items Per Order"
                                  className="form-control"
                              ...
                              <div className="col-md-6 gap-2 mb-3">
                                ...
                                <input
                                  type="number"
                                  placeholder="Minimum Limit Per Order"
                                  className="form-control"
                                        ...
                                        <input
                                          ...
                                          onChange={(e) => {
                                            const inputValue =e.target.value.trimStart();
                                              setManufactureFSSAILicense(inputValue);
                                            // if (
                                            //   inputValue === "" ||
                                            //   Number(inputValue) >= 0
                                            // ) {
