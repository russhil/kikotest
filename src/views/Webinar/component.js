// import { initializeFacebookPixel } from "./pixel";
...
import CoverWebinarSection from "./cover-webinar-section";
...
import YourWebinarSection from "./your-webinar-section";
  ...
  useEffect(() => {
    ...
    if (process.env.NODE_ENV !== "development") {
      if (!window.fbq) {
        ...
        // window.fbq("init", pixelId); // Pixel 2
      }
                ...
                <div className="webinar-hero-inner">
                  ...
                  <div>
                    <div className="webinar-hero-title">
                      Get you Kirana Shop Online within{" "}
                      <div className="yellow-text">2 Hours</div>
                    </div>
                    <div className="webinar-hero-text">
                      Are you an offline seller looking to take your business
                      online? Join our free webinar and learn the essential
                      strategies to transition your Kirana store into a thriving
                      digital marketplace
                    </div>
